...
sealed partial class App : Application
{
    ...
    private static IServiceProvider ConfigureServices()
    {
        ...
        services.AddSingleton<INavigationService, NavigationService>(_ => new NavigationService(
            ...
            new KeyValuePair<Type, Type>(typeof(RecentPageViewModel), typeof(RecentPage)),
            new KeyValuePair<Type, Type>(typeof(FavoritesPageViewModel), typeof(FavoritesPage)),
            new KeyValuePair<Type, Type>(typeof(TagPageViewModel), typeof(TagPage)),
