...
public sealed partial class NotificationViewModel : ObservableRecipient,
    ...
    IRecipient<CustomThumbnailSetNotificationMessage>,
    ...
    IRecipient<PlaylistItemsAddedNotificationMessage>
{
    ...
    public void Receive(CustomThumbnailSetNotificationMessage message)
    {
        ShowSuccessNotification("Custom thumbnail set", message.MediaName);
    }
