...
public sealed partial class VideosPage : Page, IContentFrame
{
    ...
    {
        Common.NavigationStates.Remove(typeof(VideosPage));
        ContentFrame.BackStack.Clear();
        LibraryNavView.SelectedItem = FoldersMenuItem;
        ContentFrame.Navigate(typeof(FolderViewPage), "VideosLibrary", new SuppressNavigationTransitionInfo());
    }
