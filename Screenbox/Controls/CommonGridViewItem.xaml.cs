...
public sealed partial class CommonGridViewItem : UserControl
{
    ...
    public static readonly DependencyProperty IsThumbnailLoadingProperty = DependencyProperty.Register(
        nameof(IsThumbnailLoading), typeof(bool), typeof(CommonGridViewItem), new PropertyMetadata(default(bool)));

    public bool IsThumbnailLoading
    {
        get => (bool)GetValue(IsThumbnailLoadingProperty);
        set => SetValue(IsThumbnailLoadingProperty, value);
    }
