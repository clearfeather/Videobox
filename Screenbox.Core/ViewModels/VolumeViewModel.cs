...
namespace Screenbox.Core.ViewModels
{
        ...
        IRecipient<PropertyChangedMessage<IMediaPlayer?>>
    {
        ...
        public VolumeViewModel(ISettingsService settingsService, PlayerContext playerContext)
        {
            ...
            _volume = GetStartupVolume();
            _isMute = settingsService.StartupVolumeMode == StartupVolumeMode.Muted || _volume == 0;
        ...
        private void ApplyVolumeToMediaPlayer()
        {
            if (MediaPlayer == null) return;
