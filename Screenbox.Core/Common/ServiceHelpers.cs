...
public static class ServiceHelpers
{
    public static void PopulateCoreServices(ServiceCollection services)
    {
        ...
        services.AddTransient<RecentPageViewModel>();
        services.AddTransient<FavoritesPageViewModel>();
        services.AddTransient<TagPageViewModel>();
        ...
        services.AddSingleton<FavoritesContext>();
        ...
        services.AddSingleton<IThumbnailLoadingService, ThumbnailLoadingService>();
    }
}
